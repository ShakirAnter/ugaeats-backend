...
exports.normalizeUgandaPhone = normalizeUgandaPhone;
exports.isValidUgandaPhone = isValidUgandaPhone;
function normalizeUgandaPhone(input) {
    if (!input)
        return null;
...
function isValidUgandaPhone(input) {
    if (!input)
        return false;
